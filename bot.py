...
dispatcher.add_handler(CommandHandler('price', send(trading.price)))
...
dispatcher.add_handler(CommandHandler('trade', restricted(send(trading.trade))))
dispatcher.add_handler(CommandHandler('tradeAll', restricted(send(trading.tradeAll))))
dispatcher.add_handler(CommandHandler('newAccount', restricted(send(trading.newAccount))))
dispatcher.add_handler(CommandHandler('deleteAccount', restricted(send(trading.deleteAccount))))
dispatcher.add_handler(CommandHandler('subscribe', restricted(subscribe)))
